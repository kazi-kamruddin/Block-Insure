module.exports = [
  ...
  "function getBenefitTermsVersion(uint256 packageId,uint32 version) view returns (tuple(bool configured,bool deathBenefitEnabled,bool surrenderEnabled,bool maturityEnabled,uint16 deathBenefitBps,uint16 surrenderValueBps,uint16 maturityBonusBps,uint16 minimumSurrenderInstallments,uint32 version,bytes32 termsHash))",
  "function getAcceptedBenefitTerms(uint256 policyId) view returns (tuple(bool configured,bool deathBenefitEnabled,bool surrenderEnabled,bool maturityEnabled,uint16 deathBenefitBps,uint16 surrenderValueBps,uint16 maturityBonusBps,uint16 minimumSurrenderInstallments,uint32 version,bytes32 termsHash))",
